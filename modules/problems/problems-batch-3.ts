export const batch3 = [
    {
        ...
        description: "Given an integer num, repeatedly add all its digits until the result has only one digit, and return it. Could you do it without any loop/recursion in O(1) runtime?",
