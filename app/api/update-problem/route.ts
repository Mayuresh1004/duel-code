...
import { currentUserRole, getCurrentProblem, getCurrentUser } from "@/modules/auth/actions";
...
export async function PUT(request: NextRequest) {
    try {
        ...
        // const problemId  = await getCurrentProblem(problemId)
        ...
        let errorMessage = "Failed to update the problem";
